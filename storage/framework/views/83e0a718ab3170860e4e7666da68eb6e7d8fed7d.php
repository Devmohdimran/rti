                    ...
                    <div class="content-part">
                        <div class="sec-title">
                            <div class="title-icon md-mb-15">
                                <img src="<?php echo e(asset('web/assets/images/newsletter.png')); ?>" alt="images">
                            </div>
...
<!-- modernizr js -->
<script src="<?php echo e(asset('web/assets/js/modernizr-2.8.3.min.js')); ?>"></script>
<!-- jquery latest version -->
<script src="<?php echo e(asset('web/assets/js/jquery.min.js')); ?>"></script>
<!-- Bootstrap v4.4.1 js -->
<script src="<?php echo e(asset('web/assets/js/bootstrap.min.js')); ?>"></script>
<!-- Menu js -->
<script src="<?php echo e(asset('web/assets/js/rsmenu-main.js')); ?>"></script>
<!-- op nav js -->
<script src="<?php echo e(asset('web/assets/js/jquery.nav.js')); ?>"></script>
<!-- owl.carousel js -->
...
<!-- wow js -->
<script src="<?php echo e(asset('web/assets/js/wow.min.js')); ?>"></script>
<!-- Skill bar js -->
<script src="<?php echo e(asset('web/assets/js/skill.bars.jquery.js')); ?>"></script>
<script src="<?php echo e(asset('web/assets/js/jquery.counterup.min.js')); ?>"></script>
<!-- counter top js -->
<script src="<?php echo e(asset('web/assets/js/waypoints.min.js')); ?>"></script>
<!-- video js -->
<script src="<?php echo e(asset('web/assets/js/jquery.mb.YTPlayer.min.js')); ?>"></script>
<!-- magnific popup js -->
<script src="<?php echo e(asset('web/assets/js/jquery.magnific-popup.min.js')); ?>"></script>
<!-- plugins js -->
<script src="<?php echo e(asset('web/assets/js/plugins.js')); ?>"></script>
<!-- contact form js -->
<script src="<?php echo e(asset('web/assets/js/contact.form.js')); ?>"></script>
<!-- main js -->
...
</html><?php /**PATH C:\xampp\htdocs\RTI\merazrti\resources\views/web/inc/footer.blade.php ENDPATH**/ ?>