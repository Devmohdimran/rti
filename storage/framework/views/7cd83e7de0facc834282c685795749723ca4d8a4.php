...
<?php $__env->startSection('title', 'Create Marksheet'); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-4 border rounded"> 
                        <form class="row g-3 needs-validation bv-form" method="post" id="enq_form" enctype="multipart/form-data" action="<?php echo e(route('storeMarksheet')); ?>" novalidate="novalidate">
                            <?php echo csrf_field(); ?>
                            <div class="col-md-6">
                                <label for="_reg_no" class="form-label">Reg No *</label>
                                <input type="text" class="form-control" name="reg_no" id="_reg_no" value="<?php echo e($data['student'][0]['reg']); ?>" placeholder="Reg No" readonly>
                            </div>
                            <div class="col-md-6">
                                <label for="_stu_name" class="form-label">Student Name *</label>
                                <input type="text" class="form-control" name="stud_name" id="_stu_name" value="<?php echo e($data['student'][0]['name']); ?>" placeholder="Student Name" readonly>
                            </div>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RTI\merazrti\resources\views/admin/admit_card_result/create_marksheet.blade.php ENDPATH**/ ?>