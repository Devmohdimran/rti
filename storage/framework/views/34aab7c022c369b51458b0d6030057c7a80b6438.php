<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="<?php echo e(route('addNewEnquiry')); ?>"><i class="bx bx-right-arrow-alt"></i>Add New Enquiry </a>
                </li>
                <li>
                    <a href="<?php echo e(route('listEnquiry')); ?>"><i class="bx bx-right-arrow-alt"></i>List Enquiry</a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul>
                <li>
                    <a href="<?php echo e(route('newStudent')); ?>"><i class="bx bx-right-arrow-alt"></i>New Admission</a>
                </li>
                <li> 
                    <a href="<?php echo e(route('studentList')); ?>"><i class="bx bx-right-arrow-alt"></i>Student List</a>
                </li>
                <li>
                    <a href="<?php echo e(route('studentBday')); ?>"><i class="bx bx-right-arrow-alt"></i>Student Bday</a>
                </li>
                <li>
                    <a href="<?php echo e(route('studentListprint')); ?>"><i class="bx bx-right-arrow-alt"></i>Print Student List</a>
                </li>
                <li>
                    <a href="<?php echo e(route('courseManage')); ?>"><i class="bx bx-right-arrow-alt"></i>Course Management</a>
                </li>
                <li>
                    <a href="<?php echo e(route('studentIdcard')); ?>"><i class="bx bx-right-arrow-alt"></i>Head Office ID Card</a>
                </li>
                <li>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="<?php echo e(route('createAdmitCard')); ?>"><i class="bx bx-right-arrow-alt"></i>Create Admit Card</a>
                </li>
                <li>
                    <a href="<?php echo e(route('admitCardDtails')); ?>"><i class="bx bx-right-arrow-alt"></i>Admit Card Details</a>
                </li>
                <li>
                    <a href="<?php echo e(route('adminResult')); ?>"><i class="bx bx-right-arrow-alt"></i>Result</a>
                </li>
                <li>
                    <a href="<?php echo e(route('BranchAdmitCard')); ?>"><i class="bx bx-right-arrow-alt"></i>Branch Admit Card</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="<?php echo e(route('FeeSubmission')); ?>"><i class="bx bx-right-arrow-alt"></i>Fee Submission</a>
                </li>
                <li>
                    <a href="<?php echo e(route('FeeDetails')); ?>"><i class="bx bx-right-arrow-alt"></i>Fee Details</a>
                </li>
                <li>
                    <a href="<?php echo e(route('todayFeeCollection')); ?>"><i class="bx bx-right-arrow-alt"></i>Today Fee Collection</a>
                </li>
                <li>
                    <a href="<?php echo e(route('dueFeeReport')); ?>"><i class="bx bx-right-arrow-alt"></i>Due Fee Report</a>
                </li>
                <li>
                    <a href="<?php echo e(route('FeeReminder')); ?>"><i class="bx bx-right-arrow-alt"></i>Fee Reminder</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="<?php echo e(route('NewBranchAdd')); ?>"><i class="bx bx-right-arrow-alt"></i>Add New Branch</a>
                </li>
                <li>
                    <a href="<?php echo e(route('BranchDetails')); ?>"><i class="bx bx-right-arrow-alt"></i>Branch Details</a>
                </li>
    ...
    <!--end navigation-->
</div><?php /**PATH C:\xampp\htdocs\RTI\merazrti\resources\views/admin/inc/left_sidebar.blade.php ENDPATH**/ ?>