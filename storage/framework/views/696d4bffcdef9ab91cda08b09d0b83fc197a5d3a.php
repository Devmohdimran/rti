        ...
        <div class="row relative">
            ...
            <div class="col-lg-6 lg-pl-0">
                <div class="banner-line-shape js-tilt">
                    <!-- <img src="<?php echo e(asset('web/assets/images/banner/banner-line.png')); ?>" alt="Banner Circle Shape"> -->
                </div>
                ...
                <div class="banner-circle-shape js-tilt">
                    <img src="<?php echo e(asset('web/assets/images/banner/banner-circle.png')); ?>" alt="Banner Circle Shape">
                </div>
            </div>
        </div>
        <div class="banner-dots-shape js-tilt">
            <img src="<?php echo e(asset('web/assets/images/banner/banner-dots.png')); ?>" alt="Banner Dots Shape">
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="courses-item">
                    <div class="courses-grid">
                        <div class="img-part">
                            <a href="#"><img src="<?php echo e(asset('web/assets/images/1.jpg')); ?>" alt=""></a>
                        </div>
            ...
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="courses-item">
                    <div class="courses-grid">
                        <div class="img-part">
                            <a href="#"> <img src="<?php echo e(asset('web/assets/images/2.jpg')); ?>" alt=""></a>
                        </div>
                        <div class="content-part">
            ...
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="courses-item">
                    <div class="courses-grid">
                        <div class="img-part">
                            <a href="#"><img src="<?php echo e(asset('web/assets/images/3.jpg')); ?>" alt=""></a>
                        </div>
                        <div class="content-part">
        ...
        <div class="col-md-5">
            ...
            <div class="event media mt-20 mb-10 no-bg no-border">
                <div class="event-date media-left pull-left flip">
                    <img src="<?php echo e(asset('web/assets/images/subject/icons/1.png')); ?>" class="img-circle img-thumbnail mt-5" alt="">
                </div>
        ...
        <div class="col-md-7">
            <div class="row">
                <div class="col-sm-6 mt-30">
                    <img src="<?php echo e(asset('web/assets/images/dc1.png')); ?>" alt="">
                </div>
                <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="subject-wrap bgc1">
                    <img src="<?php echo e(asset('web/assets/images/subject/icons/1.png')); ?>" alt="">
            ...
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="subject-wrap bgc2 text-light">
                    <img src="<?php echo e(asset('web/assets/images/subject/icons/2.png')); ?>" alt="">
            ...
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="subject-wrap bgc3">
                    <img src="<?php echo e(asset('web/assets/images/subject/icons/3.png')); ?>" alt="">
            ...
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="subject-wrap bgc4">
                    <img src="<?php echo e(asset('web/assets/images/subject/icons/4.png')); ?>" alt="">
            ...
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="subject-wrap bgc5">
                    <img src="<?php echo e(asset('web/assets/images/subject/icons/5.png')); ?>" alt="">
            ...
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="subject-wrap bgc6">
                    <img src="<?php echo e(asset('web/assets/images/subject/icons/6.png')); ?>" alt="">
    ...
    <div class="Container pb-4 mb-4">
        <div class="MoreBranch mb-4">
            ...
            <div class="">
                <div class="">
                    <div class="">
                        <img src="<?php echo e(asset('web/assets/images/blog/style2/3.jpg')); ?>" alt="">
                    </div>
                    <div class="">
            ...
            <div class="ProductBlock">
                <div class="testimonial-wrapper text-center bg-theme-colored p-3">
                    <div class="thumb mb-30">
                        <img class="img-circle img-thumbnail" alt="" src="<?php echo e(asset('web/assets/images/blog/style2/3.jpg')); ?>">
                    </div>
...
<?php echo $__env->make('web.webapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RTI\merazrti\resources\views/web/home.blade.php ENDPATH**/ ?>