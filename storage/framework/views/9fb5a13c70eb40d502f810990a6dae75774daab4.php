            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-4 border rounded"> 
                        <form class="row g-3 needs-validation bv-form" method="post" id="enq_form" enctype="multipart/form-data" action="<?php echo e(route('branchupdateMarksheet')); ?>" novalidate="novalidate">
                            <?php echo csrf_field(); ?>
                            <div class="col-md-6">
...
<?php echo $__env->make('branch.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RTI\merazrti\resources\views/branch/admit_card_result/edit_marksheet.blade.php ENDPATH**/ ?>